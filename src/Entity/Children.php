...
class Children
{
    ...
    #[ORM\OneToMany(mappedBy: 'adherant', targetEntity: Comment::class)]
    ...
    public function removeComment(Comment $comment): self
    {
        if ($this->comments->removeElement($comment)) {
            ...
            if ($comment->getAdherant() === $this) {
                $comment->setAdherant(null);
            }
        }
